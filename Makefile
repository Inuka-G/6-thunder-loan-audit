...
install :; forge install foundry-rs/forge-std  && forge install openzeppelin/openzeppelin-contracts@v5.0.2  && forge install openzeppelin/openzeppelin-contracts-upgradeable@v5.0.2 
